...
public class ViagemVoo extends Transporte {
    ...
    public ViagemVoo(String id, String nome, double precoBase, int vagas, String localOrigem,
                      String localDestino, String companhia, String horarioEmbarque, double taxaEmbarque) {
